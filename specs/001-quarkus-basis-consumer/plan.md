...
| JPA + JavaDB (Apache Derby)                                                                       | Tenant configuration persistence, audit log, `AppConfigProperty` table for DB-backed MicroProfile Config               |
