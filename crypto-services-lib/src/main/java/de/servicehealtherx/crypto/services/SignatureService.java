...
public class SignatureService {
    ...
    public enum SignatureFormat { CADES, PADES, XADES }

    public enum VerificationResult { VALID, INVALID, INCONCLUSIVE }
    ...
    private String resolveHashAlgorithm(int hashLength) {
        return switch (hashLength) {
            ...
            default -> throw new IllegalArgumentException(
                "Unsupported hash length: " + hashLength + " bytes. Expected 32 (SHA-256), 48 (SHA-384), or 64 (SHA-512).");
        };
    }
