...
description: Perform OWASP LLM Top 10 2025 threat analysis on skill files. Generates
  threat-model-{date}-{seq}.md.
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: threatmodel:commands/analyze.md
---
...
**Render the output by filling `.specify/templates/threat-model.md`.** The template is the single source of truth for output format. Do NOT invent alternative layouts, restructure sections, change section order, or add sections not present in the template.
